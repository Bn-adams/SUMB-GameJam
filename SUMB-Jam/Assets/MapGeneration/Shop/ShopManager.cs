...
public class ShopManager : MonoBehaviour
{
    protected List<Upgrade> shelves = new List<Upgrade>()
    {
        ...
        new PistolMaxAmmo() { name = "Max Ammo", description = "Provides Another bullet for your Pistol.", icon = "Missing", price = 3, price_up = 5, stock = 2, max_stock = 2, Shelf_Chance= 15},
    };
